...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/cptjack00/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/cptjack00/LARBS/master/progs.csv"
